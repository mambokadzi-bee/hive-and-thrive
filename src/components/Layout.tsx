...
A place where high-achieving women stop surviving success and start belonging.
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.linkedin.com/company/hiveandthrive/" target="_blank" rel="noopener noreferrer" className="text-cream/50 hover:text-honey transition-colors" aria-label="LinkedIn">
